...
**Trivia Game** is an app is a fully functional SwiftUI-based that dynamically fetches trivia questions from an API, allows user interactions, and includes a timer for added challenge.
...
https://www.youtube.com/shorts/_irv0b7mj9Q
...
- Handling Answer Selection and Highlighting
- Implementing a Countdown Timer
-  Auto-Submitting Answers When Time Runs Out
